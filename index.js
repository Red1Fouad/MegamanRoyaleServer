...
rl.question('Enter the IP address: ', (ipAddress) => {
	rl.question('Enter the number of target players: ', (targetPlayersNum) => {
			var port = 25560;
		...
		class Room {
		  constructor() {
			...
			this.targetPlayers = targetPlayersNum;
			this.players = [];
		...
		rl.close(); // Close readline interface after taking IP address and targetPlayers input
    });
});